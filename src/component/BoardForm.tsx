...
const BoardForm = ({ inputs, handleInputChange }: { inputs: Inputs; handleInputChange : InputonChange }) => {
  ...
  const { nickname, password, title, content } = inputs;
    ...
    return (
        <div>
        <label>닉네임</label>
        <input type="text" name="nickname" value={nickname} onChange={handleInputChange} required/>
        <label>비밀번호</label>
        <input type="password" name="password" value={password} onChange={handleInputChange} required/>
        <label>제목</label>
        <input type="text" name="title" value={title} onChange={handleInputChange} required/>
        <label>글 내용</label>
        <input type="text" name="content" value={content} onChange={handleInputChange} required/>
        <button>등록하기</button>
</div>
    );
};
